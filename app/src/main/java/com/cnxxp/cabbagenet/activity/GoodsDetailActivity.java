    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_zan:
                ...
                if (dbHelper == null) {
                    dbHelper = SearchDBHelper.getInstance(GoodsDetailActivity.this);
                }
            ...
            case R.id.activity_more_image_bg:
                if (Build.VERSION.SDK_INT >= 23) {
                    if ((ContextCompat.checkSelfPermission(GoodsDetailActivity.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) &&
                            (ContextCompat.checkSelfPermission(GoodsDetailActivity.this,
                        ...
                        //请求获取摄像头权限
                        ActivityCompat.requestPermissions(GoodsDetailActivity.this,
...
// 将ClipData内容放到系统剪贴板里。  
    ...
    private void share(SHARE_MEDIA share_media, String title) {
        new ShareAction(this).withMedia(getShareWeb(this, mBean.getFenxiang(), mBean.getTitle(), mBean.getPrice())).setPlatform(share_media).setCallback(new UMShareListener() {
            @Override
    ...
    private void httpAd(String tag) {
        API.getSingleton().adB(tag, "20", new VolleyInterface(this) {
            ...
            public void onStateSuccess(String msg, JSONObject object) {
                ...
                Glide.with(GoodsDetailActivity.this).load(myBean.getData().get(0).getContent()).into(ivAd);
