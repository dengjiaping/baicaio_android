...
public class TutorialJumpTActivity extends BaseActivity {
    public static final String TAG = "TutorialJumpTActivity";
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_zan:
                ...
                if (dbHelper == null) {
                    dbHelper = SearchDBHelper.getInstance(TutorialJumpTActivity.this);
                }
            ...
            case R.id.activity_more_image_bg:
                if (Build.VERSION.SDK_INT >= 23) {
                    if ((ContextCompat.checkSelfPermission(TutorialJumpTActivity.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) &&
                            (ContextCompat.checkSelfPermission(TutorialJumpTActivity.this,
                        ...
                        //请求获取摄像头权限
                        ActivityCompat.requestPermissions(TutorialJumpTActivity.this,
    ...
    private void httpAd(String tag) {
        API.getSingleton().adB(tag, "20", new VolleyInterface(this) {
            ...
            public void onStateSuccess(String msg, JSONObject object) {
                ...
                Glide.with(TutorialJumpTActivity.this).load(myBean.getData().get(0).getContent()).into(ivAd);
