...
public class TagSearchActivity extends BaseActivity {
        ...
        tvAttention.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(Config.PublicParams.usid)) {
                    ...
                    intent.setClass(TagSearchActivity.this, LoginActivity.class);
    ...
    protected void initData() {
        ...
        jTag = tag.replace(" ", "|").replace("-", "|");
        setTitleText(tag);
        recyclerView.onRefresh();

    }

    private void httpTagSearch(final String tag, final int page) {
        showLoadDialog();
        API.getSingleton().tagsearch(TAG, page, "", "", tag, new VolleyInterface(this) {
            @Override
